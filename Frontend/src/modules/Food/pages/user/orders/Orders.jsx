  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-10 font-sans">
      ...
      <div className="flex justify-center mt-8 mb-4">
        <h1 className="text-4xl font-black text-gray-200 dark:text-zinc-900 tracking-tighter italic capitalize">AppzetoSuperApp</h1>
      </div>
          ...
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-zinc-900 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="px-6 py-6">
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#EB590E] to-[#D94F0C] text-white text-base font-bold py-3.5 hover:from-[#D94F0C] hover:to-[#C44409] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-primary-orange/50/30 flex items-center justify-center gap-2"
              >
                {submittingRating ? (
                  <>
