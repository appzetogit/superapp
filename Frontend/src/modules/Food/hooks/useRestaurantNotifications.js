...
export const useRestaurantNotifications = () => {
  ...
  useEffect(() => {
    ...
    if (shouldBlockConnection) {
      ...
      if (frontendHost.includes('foods.AppzetoSuperApp.com')) {
        suggestedBackendUrl = `${frontendProtocol}//api.foods.AppzetoSuperApp.com/api`;
      } else if (frontendHost.includes('AppzetoSuperApp.com')) {
