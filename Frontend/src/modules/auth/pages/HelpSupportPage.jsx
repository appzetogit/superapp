...
const DEFAULT_HELP_CONTENT = {
  title: "AppzetoSuperApp Support Center",
  ...
  categories: [
    {
      ...
      faqs: [
        {
          question: "How do I create an account on AppzetoSuperApp?",
        ...
        },
        {
          ...
          answer: "Yes! AppzetoSuperApp is a unified ecosystem. You only need one phone number and one profile to seamlessly order food and book rides."
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        {
          question: "What should I do if I leave an item in a AppzetoSuperApp ride?",
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "Refunds for cancelled rides or food orders are processed instantly on our end. Depending on your bank or payment method, the money will reflect in your account within 3-5 business days for cards/UPI, or immediately if refunded to your AppzetoSuperApp Wallet."
        },
        {
