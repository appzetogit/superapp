...
const LinksPage = () => {
  const links = [
    {
      id: 'user',
      title: 'AppzetoSuperApp - User app',
      ...
      url: 'https://play.google.com/store/apps/details?id=com.AppzetoSuperApp.user',
      type: 'Customer App',
    ...
    {
      id: 'driver',
      title: 'AppzetoSuperApp Driver',
      subtitle: 'Drive and earn with AppzetoSuperApp.',
      description: 'Join our fleet of professional drivers. Flexible hours, great earnings, and a supportive community.',
      url: 'https://play.google.com/store/apps/details?id=com.AppzetoSuperApp.driver',
      type: 'Partner App',
  ...
  React.useEffect(() => {
    document.title = "Download Apps | AppzetoSuperApp";
  }, []);
  ...
  return (
    <div className="links-page-container">
      <nav className="links-nav">
        <div className="nav-container">
          <a href="/" className="nav-logo">
            <span className="logo-AppzetoSuperApp">AppzetoSuperApp</span>
          </a>
      ...
      <div className="links-banner">
        <img src={bannerImg} alt="AppzetoSuperApp Banner" className="banner-image" />
        <div className="banner-gradient"></div>
      </div>

      <div className="links-content-wrapper">
        <header className="links-header">
          <h1 className="links-title">Download <span className="highlight">AppzetoSuperApp</span></h1>
        ...
        <footer className="links-footer">
          <p>© 2026 AppzetoSuperApp. All rights reserved.</p>
          <div className="footer-links">
            <a href="https://AppzetoSuperApp.com" target="_blank" rel="noopener noreferrer">Visit Website</a>
